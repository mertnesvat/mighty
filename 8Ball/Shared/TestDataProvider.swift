...
extension TestDataProvider {
    ...
    private func timedColor() -> [String: Any] {
        ...
        let possibleAnswers = NSArray.init(contentsOfFile: path!)

        let rd = Int.random(in: 0 ..< possibleAnswers!.count)
        let tex = possibleAnswers![rd] as! String
        ...
        return [PayloadKey.timeStamp: tex, PayloadKey.colorData: colorData]
    }
